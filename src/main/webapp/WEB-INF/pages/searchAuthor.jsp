...
<body>
<table class="style">
    <caption class="heading">Результаты поиска по автору:${message}</caption>
    ...
    <c:if test="${searchCount > 0}">
        ...
        <c:forEach var="author" items="${booksList}" varStatus="i">
            <tr>
    ...
    <tr>
        <td colspan="7" class="left-side link right-side">
            ...
            <c:if test="${pagesCount > 1}">
                ...
                <c:url value="/searchAuthor/${message}" var="url">
            ...
            <span style="margin-left: 70px; font-size: 120%">Авторов по поиску: ${searchCount}</span>
        </td>
    </tr>
</table>
</body>
