...
<body>
<table class="style">
    <caption class="heading">${message}</caption>
        <tr>
    ...
    <c:if test="${authorNameCount > 0}">
        ...
        <c:forEach var="book" items="${booksList}" varStatus="i">
            <tr>
                ...
                <td class="right-side">
                    <a href="/deleteAuthor/${book.id}/${book.author}">
    ...
    <c:if test="${authorNameCount == 0}">
        <tr>
            <td colspan="7" style="font-size: 150%" class="left-side right-side">
                Список книг данного автора пуст, вы можете добавить новую книгу!
            </td>
        </tr>
    </c:if>
    <tr>
        <td colspan="7" class="left-side link right-side">
            ...
            <c:if test="${pagesCount > 1}">
                ...
                <c:url value="/authorName/${message}" var="url">
            ...
            <span style="margin-left: 70px; font-size: 120%">Всего книг у автора: ${authorNameCount}</span>
        </td>
    </tr>
</table>
</body>
